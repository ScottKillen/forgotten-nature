...
public class ItemNewHalfPlanks extends ItemBlock
{
    ...
    {
    	if(this.itemID == forgottennature.halfPlankID)
    	{
		    switch(i.getItemDamage())
		    {
			    case 0:return "Brown slab";
			    case 1:return "Purple slab";
			    case 2:return "Dark Red slab";
			    case 3:return "Dark Yellow slab";
			    case 4:return "Peach slab";
			    case 5:return "Orange slab";
			    case 6:return "Brightwood slab";
			    case 7:return "Vibrant Redwood slab";
		    }
    	}
    	else if(this.itemID == forgottennature.halfPlankID2)
    	{
		    switch(i.getItemDamage())
		    {
			    case 0:return "Acacia slab";
			    case 1:return "Bright Yellow slab";
			    case 2:return "Old Wood slab";
			    case 3:return "Bamboo slab";
			    case 4:return "Dried Bamboo slab";
			    case 5:return "Crystalslab";
			    case 6:return "DarkCrystal slab";
		    }
    	}
    	else if(this.itemID == forgottennature.halfStoneID)
    	{
		    switch(i.getItemDamage())
		    {
			    case 0:return "Granite slab";
			    case 1:return "Gneiss slab";
			    case 2:return "Hornfels slab";
			    case 3:return "Marble slab";
			    case 4:return "granite Brick slab";
			    case 5:return "gneiss Brick slab";
			    case 6:return "hornfels Brick slab";
			    case 7:return "Marble Brick slab";
		    }
    	}
    return "";
    }
