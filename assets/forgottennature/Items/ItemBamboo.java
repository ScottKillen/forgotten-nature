...
{
    public static String[] blockNames = {"a", "b", "c", "d", "e", "f", "g",
    									"Bamboo","Bamboo","Bamboo","Bamboo","l","m","n","o"};
        ...
        else if (entityplayer.canPlayerEdit(par4, par5, par6, par7, itemstack) && entityplayer.canPlayerEdit(par4, par5 + 1, par6, par7, itemstack))
        {
            ...
            if ((var8 == Block.dirt.blockID || var8 == Block.grass.blockID || var8 == forgottennature.hempCottonBambooCornID) && world.isAirBlock(par4, par5 + 1, par6))
            {
            	if(itemstack.getItemDamage() == 11)
            		world.setBlock(par4, par5 + 1, par6, forgottennature.hempCottonBambooCornID, 11, 2);//turnip
                --itemstack.stackSize;
                return true;
            }
            else
    ...
    public String getUnlocalizedName(ItemStack i)
    {
	    switch(i.getItemDamage())
	    {
		    ...
		    case 5:return "f";
		    case 6:return "g";
		    case 7:return "Bamboo";
		    case 8:return "Bamboo";
		    case 9:return "Bamboo";
