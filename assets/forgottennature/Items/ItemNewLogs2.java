...
{
	int logID = forgottennature.newLogs2.blockID;
...
//        LanguageRegistry.addName(new ItemStack(this, 1, 10), "Cocoa Log");
//        LanguageRegistry.addName(new ItemStack(this, 1, 11), "*Cocoa Log"); --these have been removed
//        LanguageRegistry.addName(new ItemStack(this, 1, 12), "CocoaFruit Log");
//        LanguageRegistry.addName(new ItemStack(this, 1, 13), "*CocoaFruit Log");
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
                ...
                && (Block.blocksList[var11] == null || !Block.blocksList[var11].isBlockReplaceable(par3World, par4, par5, par6)))
        {
            ...
            {
            	var10 = 1;
            	logID = forgottennature.newLogs4.blockID;
                --par6;
            }
            if (par7 == 3)
            {
        ...
        else if (par3World.canPlaceEntityOnSide(this.logID, par4, par5, par6, false, par7, par2EntityPlayer, par1ItemStack))
        {
            ...
            if (logID == forgottennature.newLogs4.blockID)
            {
            	met = var14 + 1;
            }
            else
            ...
            logID = forgottennature.newLogs2.blockID;
            return true;
        }
        else
            return false;
...
//    	list.remove(new ItemStack(i, 1, 0));
    ...
    public String getUnlocalizedName(ItemStack i)
    {
	    ...
	    {
		    case 0:return "Desert Willow log*";
		    case 1:return "Desert Willow log";
		    case 2:return "Cedar log*";
		    case 3:return "Cedar log";
		    case 4:return "Ginkgo log*";
		    case 5:return "Ginkgo log";
		    case 6:return "Beech log*";
		    case 7:return "Beech log";
		    case 8:return "Walnut log*";
		    case 9:return "Walnut log";
//		    case 10:return "Cocoa log*";
//		    case 11:return "Cocoa log";
//		    case 12:return "CocoaFruit log*";
//		    case 13:return "CocoaFruit log";
		    case 14:return "WideTop Eucalyptus log*";
		    case 15:return "WideTop Eucalyptus log";
		    default:return "";
	    }
    }
}