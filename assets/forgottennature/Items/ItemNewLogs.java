...
{
	int logID = forgottennature.newLogs.blockID;
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else if (par3World.canPlaceEntityOnSide(this.logID, par4, par5, par6, false, par7, par2EntityPlayer, par1ItemStack))
        {
            ...
            if (logID == forgottennature.newLogs.blockID)
            {
            	met = var14 + var10;
            }
            else
            ...
            logID = forgottennature.newLogs.blockID;
            return true;
        }
        else
            return false;
    ...
    public String getUnlocalizedName(ItemStack i)
    {
	    ...
	    {
		    case 0:return "cherry log*";
		    case 1:return "cherry log";
		    case 2:return "ironwood log*";
		    case 3:return "ironwood log";
		    case 4:return "Eucalyptus log*";
		    case 5:return "Eucalyptus log";
		    case 6:return "Sequoia log*";
		    case 7:return "Sequoia log";
		    case 8:return "Acacia log*";
		    case 9:return "Acacia log";
		    case 10:return "Joshua log*";
		    case 11:return "Joshua log";
		    case 12:return "Swamp Willow log*";
		    case 13:return "Swamp Willow log";
		    case 14:return "Palm log*";
		    case 15:return "Palm log";
		    default:return "";
	    }
    }
}