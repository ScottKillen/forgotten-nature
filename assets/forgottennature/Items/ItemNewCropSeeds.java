...
public class ItemNewCropSeeds extends Item
{
        ...
        else if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, itemstack) && par2EntityPlayer.canPlayerEdit(par4, par5 + 1, par6, par7, itemstack))
        {
            ...
            if (var8 == this.soilBlockID && world.isAirBlock(par4, par5 + 1, par6))
            {
            	if(itemstack.getItemDamage() == 0)
            		world.setBlock(par4, par5 + 1, par6, blockType0, 0, 2);//kcelery
            	else
            	if(itemstack.getItemDamage() == 1)
                	world.setBlock(par4, par5 + 1, par6, blockType3, 0, 2);//corn
            	else
                if(itemstack.getItemDamage() == 2)
                    world.setBlock(par4, par5 + 1, par6, blockType3, 4, 2);//cotton
                else
                if(itemstack.getItemDamage() == 3)
                   	world.setBlock(par4, par5 + 1, par6, blockType2, 12, 2);//rice
                else
                if(itemstack.getItemDamage() == 4)
                    world.setBlock(par4, par5 + 1, par6, blockType4, 0, 2);//tomato
                else
                if(itemstack.getItemDamage() == 5)
                  	world.setBlock(par4, par5 + 1, par6, blockType4, 4, 2);//cabbage
                else
                if(itemstack.getItemDamage() == 6)
                   	world.setBlock(par4, par5 + 1, par6, blockType4, 8, 2);//pineapple
                else
                if(itemstack.getItemDamage() == 7)
                    world.setBlock(par4, par5 + 1, par6, blockType4, 12, 2);//grapes
                else
                if(itemstack.getItemDamage() == 8)
                    world.setBlock(par4, par5 + 1, par6, blockType3, 12, 2);//hemp
                else
                if(itemstack.getItemDamage() == 9)
                    world.setBlock(par4, par5 + 1, par6, blockType2, 4, 2);//broccoli
                else
                	world.setBlock(par4, par5 + 1, par6, blockType2, 0, 2);//parsley
                --itemstack.stackSize;
                return true;
            }
            else
    ...
    public String getUnlocalizedName(ItemStack i)
    {
	    ...
	    {
		    case 0:return "Celerys";
		    case 1:return "Corns";
		    case 2:return "Cottons";
		    case 3:return "Rices";
		    case 4:return "Tomatos";
		    case 5:return "Cabbages";
		    case 6:return "Pineapples";
		    case 7:return "Grapess";
		    case 8:return "Hemps";
		    case 9:return "Broccolis";
		    case 10:return "Parsleys";
		    default:return "";
	    }
    }
}
