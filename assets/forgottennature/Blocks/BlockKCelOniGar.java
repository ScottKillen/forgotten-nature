...
public class BlockKCelOniGar extends BlockFlower
{
    ...
    public void dropBlockAsItemWithChance(World world, int i, int j, int k, int met, float par6, int par7)
    {
        ...
        if (met == 3)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,0));//cel
        }
        else if (met == 7)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,1));//onion
        }
        else if (met == 11)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,2));//garlic
        }
        ...
        for (int n = 0; n < 5; n++)
        {
            ...
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[seedID],1,0));
            }
            else if ((met == 7) && (world.rand.nextInt(3) == 0))
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,1));
            }
            else if ((met == 11) && (world.rand.nextInt(3) == 0))
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,2));
            }
        }
    }
