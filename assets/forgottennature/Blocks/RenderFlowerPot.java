...
public class RenderFlowerPot implements ISimpleBlockRenderingHandler
{
			...
			Block block, int modelId, RenderBlocks renderer) 
	{
        ...
        var12 = 0.1865F;
        renderer.renderFaceXPos(block, (double)((float)x - 0.5F + var12), (double)y, (double)z, var8);//southface
        renderer.renderFaceXNeg(block, (double)((float)x + 0.5F - var12), (double)y, (double)z, var8);//northface
        renderer.renderFaceZPos(block, (double)x, (double)y, (double)((float)z - 0.5F + var12), var8);//west
        renderer.renderFaceZNeg(block, (double)x, (double)y, (double)((float)z + 0.5F - var12), var8);//east
        renderer.renderFaceYPos(block, (double)x, (double)((float)y - 0.5F + var12 + 0.1875F), (double)z, this.getBlockIcon(Block.dirt));//top
