...
public class BlockCrystalMushroomBlock extends Block
{
    ...
    {
    	return par2 == 0 && (par1 == 0 || par1 == 1) ? this.field_94349_a[0] : 
    		(par2 == 0 && par1 > 1 ? this.field_94349_a[1] : this.field_94349_a[2]);
    }
...
//	        {
//	            dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[mod_forgottennature.crystalItemID], 1, 4));    //blackCrystal
//	        }
        }
    }
}
