...
public class BlockNewLeaves3 extends BlockLeavesBase implements IShearable
{
    	...
    	if (!world.isRemote)
        {
	        ...
	        if (((l & 7) == 3 || (l & 7) == 6) && world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(4) == 0)
	        {
	            ...
	            if (ll == 0)
	            {
	                ...
	                {
	                    world.setBlock(i, j - 1, k, fruitID, 3, 2);    //palm
	                }
	                if ((l & 7) == 6 && random.nextInt(100) == 0)
	                {
	                    world.setBlock(i, j - 1, k, fruitID, 4, 2);    //ginkgo
	                }
	            }
	        }
    ...
    public void dropBlockAsItemWithChance(World world, int i, int j, int k, int l, float f, int i1)
    {
        ...
        if (world.rand.nextInt(7) < 1)
        {
            ...
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap, 1, 13));    //willow
            }

            if ((l & 7) == 1)
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap, 1, 14));    //decBush
            }

            if ((l & 7) == 2)
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap, 1, 15));    //everBush
            }

            if ((l & 7) == 3)
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap2, 1, 0));    //palm
            }

            if ((l & 7) == 4 && world.rand.nextInt(4) == 0)
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap2, 1, 1));    //dWillow
            }

            if ((l & 7) == 5 && world.rand.nextInt(4) == 0)
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap2, 1, 2));    //cedar
            }

            if ((l & 7) == 7 && world.rand.nextInt(2) == 0)
            {
                dropBlockAsItem_do(world, i, j, k, new ItemStack(forgottennature.newSap2, 1, 4));    //poplar
            }
        }
    }
