...
public class BlockParsWChestRiceBroc extends BlockFlower
{
    ...
    public void dropBlockAsItemWithChance(World world, int i, int j, int k, int met, float par6, int par7)
    {
        ...
        if (met == 3)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,7));//parsley
        }
        else if (met == 7)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,15));//broccoli
        }
        else if (met == 11)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,9));//wChest
        }
        else if (met == 15)
        {
        	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,10));//rice
        }
        ...
        for (int n = 0; n < 5; n++)
        {
            ...
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[seedID],1,10));
            }
            else if ((met == 7) && (world.rand.nextInt(3) == 0))
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[seedID],1,9));
            }
            else if ((met == 11) && (world.rand.nextInt(3) == 0))
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[foodID],1,9));
            }
            else if ((met == 15) && (world.rand.nextInt(3) == 0))
            {
            	dropBlockAsItem_do(world, i, j, k, new ItemStack(Item.itemsList[seedID],1,3));
            }
        }
    }
