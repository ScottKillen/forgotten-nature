    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        for (int i2 = -1; i2 <= 1; i2++)
        {
            for (int k2 = -1; k2 <= 1; k2++)
            {
                ...
                {
                    world.setBlock(i1 + i2, j1 + k3, k1 + k2, Block.wood.blockID, 0, 2);
                }
            }
        }
        ...
        //First Branch
        mainBranch(world, random, i1+2, j1+4, k1+2, 1, 1, size, leaf, leafmeta);
        mainBranch(world, random, i1+2, j1+4, k1, 1, 0, size, leaf, leafmeta);
        inner(world, random, i1+1, j1+5, k1+1, 1, 1, size, leaf, leafmeta);
        inner(world, random, i1+1, j1+5, k1, 1, 0, size, leaf, leafmeta);
        innerInner(world, random, i1, j1 + 6 + size/2, k1, 1, 1, size, leaf, leafmeta);
        //Second main Branch
        mainBranch(world, random, i1+2, j1+4, k1-2, 1, -1, size, leaf, leafmeta);
        mainBranch(world, random, i1, j1+4, k1-2, 0, -1, size, leaf, leafmeta);
        inner(world, random, i1+1, j1+5, k1-1, 1, -1, size, leaf, leafmeta);
        inner(world, random, i1, j1+5, k1-1, 0, -1, size, leaf, leafmeta);
        innerInner(world, random, i1, j1 + 6 + size/2, k1, 1, -1, size, leaf, leafmeta);
        //third main branch
        mainBranch(world, random, i1-2, j1+4, k1-2, -1, -1, size, leaf, leafmeta);
        mainBranch(world, random, i1-2, j1+4, k1, -1, 0, size, leaf, leafmeta);
