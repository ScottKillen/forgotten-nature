...
public class genCherry extends WorldGenerator
{
    ...
    public genCherry(int i, int j, int k, int l)
    {
    	...
    	logID = k;
    	logMeta = l;
    	if(leafID == forgottennature.leafIDindex+1 && leafMeta == 1 && rand.nextInt(10) == 0)
    		leafMeta = 2;
    }
        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    {
                        this.setBlockAndMetadata(this.worldObj, var11[0], var11[1], var11[2], leafID, leafMeta);
                        ++var13;
                    }
                }
            }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        if (var4[var6] != 0)
        {
            ...
            for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
            {
                ...
                this.setBlockAndMetadata(this.worldObj, var14[0], var14[1], var14[2], logID, logMeta);
            }
        }
    }
