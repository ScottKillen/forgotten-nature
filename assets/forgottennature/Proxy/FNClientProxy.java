...
//	        LanguageRegistry.addName(new ItemStack(this, 1, 2), "Cocoa Leaves");
...
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 1]), "es_ES", "Purple Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 2]), "es_ES", "Dark Red Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 3]), "es_ES", "Dark Yellow Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 4]), "es_ES", "Peach Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 5]), "es_ES", "Orange Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 6]), "es_ES", "Brightwood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 7]), "es_ES", "Redwood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 8]), "es_ES", "Acacia Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 9]), "es_ES", "Bright Yellow Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 10]), "es_ES", "Old Wood Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 11]), "es_ES", "Bamboo Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 12]), "es_ES", "Dried Bamboo Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 13]), "es_ES", "Crystal Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[stairIndex + 14]), "es_ES", "Dark Crystal Stairs");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[forgottennature.torchID]), "es_ES", "Crystal Torch");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[forgottennature.groundID]), "es_ES", "Crystal Groundcover");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[forgottennature.mushroomPlantID]), "es_ES", "Crystal Mushroom");
//        LanguageRegistry.instance().addNameForObject(new ItemStack(Item.itemsList[forgottennature.mushroomBlockID]), "es_ES", "Crystal Mushroom Block");
    }
}
